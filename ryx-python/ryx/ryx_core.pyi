...
__version__: str
"""Semver version of the compiled Rust core ``"0.2.0"``."""
...
def get_backend(alias: str = 'default') -> str:
    """Return the backend name for the specified database alias."""
    ...
